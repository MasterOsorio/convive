...
//indica que esta clase se encarga de configurar la conexion a la base de datos
@Configuration
//habilita el manejo de transacciones
@EnableTransactionManagement
//busca todas las clases que estan anotadas con Component, Repository, Service
@ComponentScan()
public class DBConfig {
	...
	//sirve para leer el archipo de propiedades
	//sin la anotacion el valor es nulo
	@Resource
